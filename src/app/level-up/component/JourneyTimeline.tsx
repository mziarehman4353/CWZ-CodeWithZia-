...
const events = [
  ...
  },
  {
    ...
    title: 'G20 Summit Conference 2025',
    mode: 'Physical Universitas Airlanga',
    notes: 'Presenting Saudia Arabia as an Delegates',
  },
  {
    date: 'November 12 – December 3, 2024',
    title: 'COIL Project',
    mode: 'Online',
    notes: 'Collaborative learning project.',
  },
  {
  ...
  return (
    <section className="py-16 px-4 sm:px-8 md:px-16 lg:px-32 max-w-screen-xl mx-auto">
      <div className="relative border-l-2 border-blue-600 py-14 bg-gray-950s group max-w-6xl mx-auto px-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 rounded-2xl bg-neutral-100 dark:bg-neutral-900">
        {events.map((event) => (
          <motion.div
            key={event.title} // ✅ use event.title instead of index
            initial={{ opacity: 0, x: event.mode === 'Online' ? 50 : -50 }} // a little smarter: online slides from right, physical from left
